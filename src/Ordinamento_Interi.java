...
public class Ordinamento_Interi {
    ...
    public static void main(String[] args) {
    	...
    	/**
    	 * @param time_integer: vi verrà salvato il tempo impiegato dall'algoritmo integersort;
    	 * @param time_quick: vi verrà salvato il tempo impiegato dall'algoritmo quicksort;
    	 * @param time_merge: vi verrà salvato il tempo impiegato dall'algoritmo mergesort;
    	 * @param time_heap: vi verrà salvato il tempo impiegato dall'algoritmo heapsort;
    	 * @param time_radix: vi verrà salvato il tempo impiegato dall'algoritmo radix-sort;
    	 */
    	long time_integer=0, time_quick=0, time_merge=0, time_heap=0, time_radix=0;
    	/**
    	 * @param array_random[]: vi verrà salvato l'array da ordinare;
    	 * @param dimensione: questa sarà la dimensione dell'array decisa da utente successivamente;
    	 */
		 ...
		 * e seguendo il precorso che più si desidera;
		 */
		...
		/* Algoritmo selezionato */
		 	...
		 	/**
		 	 * invece di una serie di if-else è stata usata la funzione switch
		 	 * a seconda del caso si viene rimandati alla funzione di ordinamento scelta precedentemente
		 	 */

    	 	switch (scelta) {
 				case 0:														/* Il case 0 ricrea un'array con numeri random che sovrascriverà il precedente */
